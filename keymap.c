...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust| Alt  | ESC  | GUI  |Lower | Mhen |Space |Space | Henk |Raise |LCA(j)|LCA(k)|LCA(l)|LCA(;)|
   * `-------------------------------------------------------------------------------------------------'
   */
  [_BASE] = LAYOUT( \
    ...
    ML_ADJ,  KC_LALT, KC_ESC, KC_LGUI, ML_LOW, JP_MHEN, KC_SPC,  KC_SPC,  JP_HENK, ML_RAI, LCA(KC_J), LCA(KC_K), LCA(KC_K), LCA(KC_SCLN)  \
    ),
